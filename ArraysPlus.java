 ...
 *
 */
public abstract class ArraysPlus {
	 ...
	 * If it does not appear, returns 0;
	 * 
	 * @param obj
	 * @param arr
	 * @return
	...
	/**
	 * Checks if the <code>obj</code> is contained within the array <code>arr</code>.
	 * 
	...
	/**
	 * Converts an array of any amounts of dimension into a custom readable String
